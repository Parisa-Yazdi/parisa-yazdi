        ...
        {menuItems.map((item) =>
          item.subPages ? (
            <div key={item.name} className="dropdown">
              <button className="dropdown-button">{item.name}</button>
              <div className="dropdown-menu">
                {Object.entries(item.subPages).map(([name, subItem]) => (
                  <a key={name} href={subItem.href}>
                    {name}
                  </a>
                ))}
              </div>
            ...
            <a key={item.name} href={item.href} className="menu-link">
              {item.name}
            </a>
          )
        )}
