...
const LatestArticles = async () => {
  ...
  console.log('🚀 ~ LatestArticles ~ subCategories:', subCategories);
  ...
  return (
    <section className="relative mx-auto h-fit bg-black pb-8 ">
      ...
      <div className=" mx-auto flex flex-col items-center justify-center  sm:w-11/12  lg:w-8/12">
        ...
        <div className="border-red-5030 mx-4 mt-12 grid w-[40%] grid-cols-1 gap-6 md:mx-auto md:w-full md:grid-cols-1">
