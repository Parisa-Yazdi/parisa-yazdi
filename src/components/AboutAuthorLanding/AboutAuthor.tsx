      ...
      <div className="flex  flex-col items-center justify-center ">
        <div className="flex w-11/12 flex-col items-center justify-evenly  md:flex-row md:gap-36">
          ...
          <div className="mt-3 h-fit w-full max-w-[567px] items-end justify-start   font-['Inter'] text-lg font-normal leading-[34.20px] text-neutral-400 antialiased">
            <h1 className="relative mb-5 mt-7 w-[474px] p-5 pb-2 pl-0 text-start font-['Cardo'] text-4xl font-normal leading-[54px] text-cyan-900 antialiased md:text-5xl">
              About Parisa
            ...
            words, combined with a handful. All the Lorem Ipsum generators on
            the Internet tend to repeated predefined chunks as necessary, making
            this the first true value generator on the Internet.
            <br />
            <br />
            It uses a dictionary of over 200 Latin words, combined with a
            handful. All the Lorem Ipsum generators on the Internet tend to
            repeated predefined chunks as necessary, making this the first true
            value generator on the Internet.
            <br />
            <br />
