...
const LatestCourses = () => {
  return (
    <>
      <div className=" items-center justify-center border-r border-black bg-slate-200 md:w-1/2">
        ...
        <div className=" p-5 pb-0 pt-0">
          ...
          <div className="scroll-snap-type-y-mandatory scrollbar-thick scrollbar-thumb-red-500 scrollbar-track-red-200 flex h-[200px] snap-x snap-mandatory flex-col gap-2 overflow-y-scroll p-5   pt-3 shadow-lg">
            <LatestCoursesCard />
            <LatestCoursesCard />
            <LatestCoursesCard />
          </div>
