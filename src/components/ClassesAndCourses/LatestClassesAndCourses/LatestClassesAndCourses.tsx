import LatestClassAndCourseCard from '@/components/ClassesAndCourses/LatestClassesAndCourses/LatestClassAndCourseCard';
      ...
      <section className="flex  bg-white pb-8 ">
        <div className="w-1/2 bg-slate-200">
          <div className="border-l border-gray-500">
            ...
            <div className=" scroll-snap-type-y-mandatory scrollbar-thick scrollbar-thumb-red-500 scrollbar-track-red-200 flex h-[200px] snap-x snap-mandatory flex-col gap-6 overflow-y-scroll p-5">
        ...
        <div className="w-1/2 bg-slate-200">
          <div className="border-l border-gray-500">
            <h1 className="relative w-fit p-5 pb-0  font-['Cardo']  text-4xl font-normal leading-[54px] text-[#014444] antialiased">
              Courses
            </h1>
            <div className=" p-5">
              <LatestClassAndCourseCard />
            </div>
          </div>
        </div>
      </section>
